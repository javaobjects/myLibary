...
+ 此项目是一个**Java J2SE（Java 2 Platform, Standard Edition）开发体系**[CMS(内容管理系统)](https://baike.baidu.com/item/CMS/315935?fr=aladdin)JAVASE项目,前端为GUI。
...
> 此项目为1.0版本的练手项目，若得空闲则会有2.0版本将会加入 如下几个功能
